...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({
            ...
            DuplicateProductVariantException.class
    })
    ...
    @ExceptionHandler({
            InactiveSupplierException.class,
            InvalidPurchaseStateException.class,
    ...
    public ResponseEntity<ApiErrorResponse> handleInventoryUpdateException(
            InventoryUpdateException ex, HttpServletRequest request) {
